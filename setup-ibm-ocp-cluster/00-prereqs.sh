...
# ─── VPC Instance Profile Availability ────────────────────────────────────
...
check "${OGX_WORKER_INSTANCE_TYPE} profile available"      check_profile "${OGX_WORKER_INSTANCE_TYPE}"
check "${POSTGRES_WORKER_INSTANCE_TYPE} profile available"  check_profile "${POSTGRES_WORKER_INSTANCE_TYPE}"
